...
INSERT INTO `authors` (`a_id`, `a_name`) VALUES
	(6, 'Agatha Christie'),
	(4, 'Antoine de Saint-ExupР вЂњР’В©ry'),
	(18, 'Arthur Conan Doyle'),
	(9, 'C. S. Lewis'),
	(7, 'Cao Xueqin'),
	(2, 'Charles Dickens'),
	(13, 'Dan Brown'),
	(20, 'Gabriel GarcР вЂњР’В­a MР вЂњР Р‹rquez'),
	(12, 'H. Rider Haggard'),
	(16, 'J. D. Salinger'),
	(5, 'J. K. Rowling'),
	(3, 'J. R. R. Tolkien'),
...
INSERT INTO `books` (`b_id`, `b_name`, `b_year`, `b_description`, `b_quantity`, `b_is_available`) VALUES
	(1, 'Don Quixote', 1612, 'The story follows the adventures of a hidalgo named Mr. Alonso Quixano who reads so many chivalric romances that he loses his sanity and decides to set out to revive chivalry, undo wrongs, and bring justice to the world, under the name Don Quixote de la Mancha. He recruits a simple farmer, Sancho Panza, as his squire, who often employs a unique, earthy wit in dealing with Don Quixote\'s rhetorical orations on antiquated knighthood. ', 20, 'Y'),
	...
	(6, 'The Hobbit', 1937, 'The Hobbit is set in a time "between the Dawn of FР вЂњР’В¦rie and the Dominion of Men", and follows the quest of home-loving hobbit Bilbo Baggins to win a share of the treasure guarded by Smaug the dragon. Bilbo\'s journey takes him from light-hearted, rural surroundings into more sinister territory.', 1, 'Y'),
	...
	(8, 'Dream of the Red Chamber', 1754, 'The novel provides a detailed, episodic record of life in the two branches of the wealthy, aristocratic Jia clanР Р†Р вЂљРІР‚Сњthe Rongguo House and the Ningguo House Р Р†Р вЂљРІР‚Сњwho reside in two large, adjacent family compounds in the capital. Their ancestors were made Dukes and given imperial titles, and as the novel begins the two houses are among the most illustrious families in the city. One of the clanР Р†Р вЂљРІвЂћСћs offspring is made a Royal Consort, and a lush landscaped garden is built to receive her visit. The novel describes the JiasР Р†Р вЂљРІвЂћСћ wealth and influence in great naturalistic detail, and charts the JiasР Р†Р вЂљРІвЂћСћ fall from the height of their prestige, following some thirty main characters and over four hundred minor ones. Eventually the Jia clan falls into disfavor with the Emperor, and their mansions are raided and confiscated.', 3, 'Y'),
	...
	(21, 'One Hundred Years of Solitude', 1967, 'One Hundred Years of Solitude is the story of seven generations of the BuendР вЂњР’В­a Family in the town of Macondo. The founding patriarch of Macondo, JosР вЂњР’В© Arcadio BuendР вЂњР’В­a, and Р вЂњРЎв„ўrsula IguarР вЂњР Р‹n, his wife (and first cousin), leave Riohacha, Colombia, to find a better life and a new home. One night of their emigration journey, while camping on a riverbank, JosР вЂњР’В© Arcadio BuendР вЂњР’В­a dreams of "Macondo", a city of mirrors that reflected the world in and about it. Upon awakening, he decides to establish Macondo at the river side; after days of wandering the jungle, JosР вЂњР’В© Arcadio BuendР вЂњР’В­a\'s founding of Macondo is utopic.', 0, 'Y'),
	(22, 'Lolita', 1955, 'The novel is notable for its controversial subject: the protagonist and unreliable narratorР Р†Р вЂљРІР‚Сњa middle-aged literature professor called Humbert HumbertР Р†Р вЂљРІР‚Сњis obsessed with the 12-year-old Dolores Haze, with whom he becomes sexually involved after he becomes her stepfather. "Lolita" is his private nickname for Dolores.', 2, 'Y');
...
INSERT INTO `subscriptions` (`sb_id`, `u_id`, `b_id`, `sb_start`, `sb_finish`, `sb_status`) VALUES
	...
	(31, 4, 9, '2017-06-30', '2017-07-04', 'E');
...
INSERT INTO `users` (`u_id`, `u_name`, `u_password`, `u_status`) VALUES
	...
	(6, 'user3', '92877af70a45fd6a2ed7fe81e1236b78', 'R'),
...
-- Dumping data for table library.users_has_role: ~14 rows (approximately)
